...
This page applies when you want to add a file to a Config Sync Group. Any changes you make here apply to all [Instances]({{< ref "content/nginx-one/glossary.md" >}}) of that Config Sync Group.
